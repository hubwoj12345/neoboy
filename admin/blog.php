...
<tr><td class="top">PANEL ADMINISTRACYJNY - dodaj wpis na blogu</td></tr>
<tr><td height="2" bgcolor="#ffffff"></td></tr>
<tr><td><div class="news">
<?	
if (isset($_POST['tresc'])) {
$data=date('Y-m-d H:i:s');
mysql_query("INSERT INTO `test`.`blog` (data,tytul,tresc,kto,demo) VALUES ('".$data."', '".$_POST['tytul']."','".$_POST['tresc']."','".$_POST['kto']."','".$_POST['demo']."')");}
?>
