...
<tr><td class="top">PANEL ADMINISTRACYJNY - usun arty</td></tr>
<tr><td height="2" bgcolor="#ffffff"></td></tr>
<tr><td><div class="news">
<?
include("../connect.php");
if (isset($_POST['ile'])) {
mysql_query("DELETE FROM arty where id=".$_POST['ile']);
mysql_query("DELETE FROM wizyty where gdzie='arty' && id=".$_POST['ile']);
mysql_query("DELETE FROM komart where id=".$_POST['ile']);}
...
echo "<br>";
$ile=$linia['id'];
echo "<form action=euarty.php method=post>";
